...
import hu.bme.aut.worktimer.network.auth.HttpBasicAuth;
import hu.bme.aut.worktimer.network.auth.ApiKeyAuth;
import hu.bme.aut.worktimer.network.auth.OAuth;
import hu.bme.aut.worktimer.network.auth.OAuth.AccessTokenListener;
import hu.bme.aut.worktimer.network.auth.OAuthFlow;
...
public class ApiClient {
   ...
   public void createDefaultAdapter() {
        ...
        String baseUrl = "https://worktimer.hu/api";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
